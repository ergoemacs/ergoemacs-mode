...
(defvar ergoemacs-layout-jcuken
  '("" "" "1" "2" "3" "4" "5" "6" "7" "8" "9" "0" "-" "=" "\\"
    "" ""  "й" "ц" "у" "к" "е" "н" "г" "ш" "щ" "з" "х" "ъ" "." ; Even though this isn't the position it allows translation.
    "" ""  "ф" "ы" "в" "а" "п" "р" "о" "л" "д" "ж" "э"  "" ""
    "" ""  "я" "ч" "с" "м" "и" "т" "ь" "б" "ю" "." "" "" ""
    ;; Shifted
    "" "Ë" "!" "\"" "#" ";" "%" ":" "?" "*" "(" ")" "_" "+" "/"
    "" ""  "Й" "Ц" "У" "К" "Е" "Н" "Г" "Ш" "Щ" "З" "Х" "Ъ" "," ; Even though this isn't the position it allows QWERTY translation...
    "" ""  "Ф" "Ы" "В" "А" "П" "Р" "О" "Л" "Д" "Ж" "\\" "" ""
    "" ""  "Э" "Я" "Ч" "С" "М" "И" "Т" "Ь" "Б" "Ю№" "" "" "")
  "Russian/Cryllic Lcuken layout.")

(require 'help-mode)
