...
related.  An easy way to do that is to get a clean  environment to
see if you can reproduce the error.  If you can load ergoemacs, then
this can be accomplished by Alt+a =ergoemacs-clean=. 
...
See if you can reproduce the bug from this empty environment.
** Testimonials
  :PROPERTIES:
