...
(ert-deftest ergoemacs-test-extract-prefixes ()
  "Tests the `ergoemacs-map-properties--extract-prefixes' function."
  ;; (load "isearch")
  (let* ((map-isearch ;; Actually `isearch-mode-map'
    ...
    (should (ergoemacs-test-same-members '([escape] [help] [f1] [27] [24] [8])
                                         (ergoemacs-map-properties--extract-prefixes map-isearch t nil)))
    (should (ergoemacs-test-same-members '("C-h" "C-x" "ESC" "<f1>" "<help>" "<escape>")
                                         (ergoemacs-map-properties--extract-prefixes map-isearch t t)))
    (should (ergoemacs-test-same-members '("C-h" "C-x" "<f1>" "<help>")
                                         (ergoemacs-map-properties--extract-prefixes map-isearch nil t)))
    (should (ergoemacs-test-same-members '([8] [24] [f1] [help])
                                         (ergoemacs-map-properties--extract-prefixes map-isearch nil nil)))
    ;; Test Sparse keymaps
    (should (ergoemacs-test-same-members '([escape] [help] [27] [24] [8])
                                         (ergoemacs-map-properties--extract-prefixes map-sparse t nil)))
    (should (ergoemacs-test-same-members '("C-h" "C-x" "ESC" "<help>" "<escape>")
                                         (ergoemacs-map-properties--extract-prefixes map-sparse t t)))
    (should (ergoemacs-test-same-members '("C-h" "C-x" "<help>")
                                         (ergoemacs-map-properties--extract-prefixes map-sparse nil t)))
    (should (ergoemacs-test-same-members '([8] [24] [help])
                                         (ergoemacs-map-properties--extract-prefixes map-sparse nil nil)))
    ;; Test Parent/Child Keymaps
    (should (ergoemacs-test-same-members '([escape] [help] [27] [24] [8])
                                         (ergoemacs-map-properties--extract-prefixes sparse-full t nil)))
    (should (ergoemacs-test-same-members '("C-h" "C-x" "ESC" "<help>" "<escape>")
                                         (ergoemacs-map-properties--extract-prefixes sparse-full t t)))
    (should (ergoemacs-test-same-members '("C-h" "C-x" "<help>")
                                         (ergoemacs-map-properties--extract-prefixes sparse-full nil t)))
    (should (ergoemacs-test-same-members '([8] [24] [help])
                                         (ergoemacs-map-properties--extract-prefixes sparse-full nil nil)))

    (should (ergoemacs-test-same-members '([escape] [help] [27] [24] [8] [f1])
                                         (ergoemacs-map-properties--extract-prefixes full-sparse t nil)))
    (should (ergoemacs-test-same-members '("<f1>" "C-h" "C-x" "ESC" "<help>" "<escape>")
                                         (ergoemacs-map-properties--extract-prefixes full-sparse t t)))
    (should (ergoemacs-test-same-members '("<f1>" "C-h" "C-x" "<help>")
                                         (ergoemacs-map-properties--extract-prefixes full-sparse nil t)))
    (should (ergoemacs-test-same-members '([f1] [8] [24] [help])
                                         (ergoemacs-map-properties--extract-prefixes full-sparse nil nil)))

    ;; Test Composed Keymaps (without parent)
    (should (ergoemacs-test-same-members '([escape] [help] [27] [24] [8])
                                         (ergoemacs-map-properties--extract-prefixes composed-no-parent-1 t nil)))
    
    (should (ergoemacs-test-same-members '("C-h" "C-x" "ESC" "<help>" "<escape>")
                                         (ergoemacs-map-properties--extract-prefixes composed-no-parent-1 t t)))
    (should (ergoemacs-test-same-members '("C-h" "C-x" "<help>")
                                         (ergoemacs-map-properties--extract-prefixes composed-no-parent-1 nil t)))
    (should (ergoemacs-test-same-members '([8] [24] [help])
                                         (ergoemacs-map-properties--extract-prefixes composed-no-parent-1 nil nil)))
    ;;
    (should (ergoemacs-test-same-members '([escape] [help] [f1] [27] [24] [8])
                                         (ergoemacs-map-properties--extract-prefixes composed-no-parent-2 t nil)))
    (should (ergoemacs-test-same-members '("C-h" "C-x" "ESC" "<f1>" "<help>" "<escape>")
                                         (ergoemacs-map-properties--extract-prefixes composed-no-parent-2 t t)))
    (should (ergoemacs-test-same-members '("C-h" "C-x" "<f1>" "<help>")
                                         (ergoemacs-map-properties--extract-prefixes composed-no-parent-2 nil t)))
    (should (ergoemacs-test-same-members '([8] [24] [f1] [help])
                                         (ergoemacs-map-properties--extract-prefixes composed-no-parent-2 nil nil)))))
